...
const navigation = [
  { id: 1, title: "Home", url: "/" },
  { id: 2, title: "Login", url: "/auth/login" },
  { id: 3, title: "Register", url: "/auth/register" },
];
...
const AuthLayout = ({ children}: { children: React.ReactNode}) => {
  ...
  return (
    <div className="h-full min-h-screen flex flex-col items-center justify-start bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-400 to-blue-800">
