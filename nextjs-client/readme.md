...
- Note: This is ReadMe for the old version where FastAPI was developed within NextJS along with a Custom GPT listed in GPT Marketplace.

That code is present in branch ``` next-fastapi-gpt ```
